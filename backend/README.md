...
## Project Structure
    ...
    ├── melv_rapidproto_yel_35937  # Django project configurations
...
1. Clone this repo and `cd melv_rapidproto_yel_35937`
...
2. Clone this repo and `cd melv_rapidproto_yel_35937`
